...
static const char *const yytname[] =
{
  ...
  "\"*\"", "\"/\"", "\"number\"", "\"(\"", "\")\"", "\";\"", "$accept",
  "lista", "expresion", "termino", "factor", YY_NULLPTR
};
...
{
       3,    -4,    21,    -5,    21,     1,     9,    -3,    -5,    -5,
      -5,    17,    -5,    14,    21,    21,    -5,    21,    21,    -5,
      -5,    -3,    -3,    -5,    -5
};
...
{
       0,     0,     0,    11,     0,     0,     0,     7,    10,     4,
      13,     0,     1,     0,     0,     0,     3,     0,     0,    12,
       2,     5,     6,     8,     9
};
...
{
      10,    12,    17,    18,     1,     2,     9,     2,     3,     4,
       3,     4,    14,    15,     0,    23,    24,    14,    15,    16,
      14,    15,    11,    13,    20,     2,    19,     0,     3,     4,
      21,    22
};

static const yytype_int8 yycheck[] =
{
       2,     0,     5,     6,     1,     4,    10,     4,     7,     8,
       7,     8,     3,     4,    -1,    17,    18,     3,     4,    10,
       3,     4,     4,     5,    10,     4,     9,    -1,     7,     8,
      14,    15
};
...
{
       0,     1,     4,     7,     8,    12,    13,    14,    15,    10,
      15,    13,     0,    13,     3,     4,    10,     5,     6,     9,
      10,    14,    14,    15,    15
};
